...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Roof Left)",   pos: { x: 20, y: 54 }, lineups: ["outside_smoke"] },
    { id: 2, name: "Spawn 2 (Roof Right)",  pos: { x: 24, y: 54 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Roof Center)", pos: { x: 22, y: 55 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 21, y: 57 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Lobby)",       pos: { x: 23, y: 56 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back Left)",   pos: { x: 81, y: 44 }, lineups: ["ct_outside_smoke"] },
    { id: 2, name: "Spawn 2 (Center)",      pos: { x: 83, y: 45 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Right)",       pos: { x: 85, y: 44 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 82, y: 43 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Heaven)",      pos: { x: 83, y: 43 }, lineups: [] },
  ],
};
