...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Roof Left)",   pos: { x: 35, y: 75 }, lineups: ["outside_smoke"] },
    { id: 2, name: "Spawn 2 (Roof Right)",  pos: { x: 38, y: 78 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Roof Center)", pos: { x: 36, y: 77 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 34, y: 80 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Lobby)",       pos: { x: 40, y: 76 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back Left)",   pos: { x: 70, y: 22 }, lineups: ["ct_outside_smoke"] },
    { id: 2, name: "Spawn 2 (Center)",      pos: { x: 72, y: 25 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Right)",       pos: { x: 74, y: 23 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 70, y: 20 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Heaven)",      pos: { x: 68, y: 24 }, lineups: [] },
  ],
};
