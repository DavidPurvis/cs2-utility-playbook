...
export const LINEUPS = {
  ...
  outside_smoke: {
    ...
    radarTarget: { worldX: 561.08, worldY: 593.24 },
  ...
  a_main_pop_flash: {
    ...
    radarTarget: { worldX: 346.04, worldY: 19.8 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ramp_smoke: {
    ...
    radarTarget: { worldX: -442.44, worldY: -1772.2 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_outside_smoke: {
    ...
    radarTarget: { worldX: 1707.96, worldY: -481.96 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_ramp_smoke: {
    ...
    radarTarget: { worldX: -12.36, worldY: -1270.44 },
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Roof Left)",   pos: { x: 73, y: 47 }, lineups: ["outside_smoke"] },
    { id: 2, name: "Spawn 2 (Roof Right)",  pos: { x: 80, y: 47 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Roof Center)", pos: { x: 76, y: 47 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 74, y: 50 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Lobby)",       pos: { x: 68, y: 50 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back Left)",   pos: { x: 54, y: 36 }, lineups: ["ct_outside_smoke"] },
    { id: 2, name: "Spawn 2 (Center)",      pos: { x: 56, y: 38 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Right)",       pos: { x: 58, y: 36 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 54, y: 34 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Heaven)",      pos: { x: 56, y: 35 }, lineups: [] },
  ],
};
