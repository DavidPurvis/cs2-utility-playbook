...
export const SETUP_POSITIONS = [
  ...
  },
  {
    ...
    side: "T",
    area: "A",
    pos: { worldX: 1087.4, worldY: 1579.921 },
  ...
  },
  {
    ...
    side: "CT",
    area: "A",
    pos: { worldX: -916.079, worldY: 1071.703 },
...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Line 3)", pos: { x: 36, y: 70 }, lineups: ["t_z_connector_smoke"] },
  ...
  CT: [
    { id: 1, name: "Spawn 1 (Mid)",    pos: { x: 44, y: 28 }, lineups: ["ct_mid_delay_smoke"] },
