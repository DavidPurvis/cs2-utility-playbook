...
export const LINEUPS = {
  ...
  t_z_connector_smoke: {
    ...
    radarPos: { worldX: -197.76, worldY: 321.36 },
    radarTarget: { worldX: 816, worldY: 997.2 },
  ...
  ct_mid_delay_smoke: {
    ...
    radarPos: { worldX: 928.64, worldY: 602.96 },
    radarTarget: { worldX: 140.16, worldY: 434 },
    source: { name: "community", url: "" },
  ...
  t_a_cross_smoke: {
    ...
    radarPos: { worldX: -479.36, worldY: 1278.8 },
    radarTarget: { worldX: -760.96, worldY: 1447.76 },
    source: { name: "community", url: "" },
  ...
  t_b_heaven_smoke: {
    ...
    radarPos: { worldX: 1829.76, worldY: 152.4 },
    radarTarget: { worldX: 2224, worldY: -241.84 },
    source: { name: "community", url: "" },
  ...
  ct_b_main_anti_rush_molly: {
    ...
    radarPos: { worldX: 2167.68, worldY: -579.76 },
    radarTarget: { worldX: 1153.92, worldY: -805.04 },
    source: { name: "community", url: "" },
    video: "https://bo3.gg/articles/cs2-cache-utility-guide-flashes-molotovs-grenades",
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    ...
    { id: 5, name: "Spawn 5 (A side)", pos: { x: 30, y: 50 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Mid)",    pos: { x: 52, y: 47 }, lineups: ["ct_mid_delay_smoke"] },
    { id: 2, name: "Spawn 2 (A)",      pos: { x: 20, y: 32 }, lineups: [] },
