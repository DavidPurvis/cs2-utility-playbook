...
export const SPAWNS = {
  T: [
    ...
    { id: 2, name: "Spawn 2 (Left)",    pos: { x: 40, y: 71 }, lineups: ["b_lurk_smoke"] },
    { id: 3, name: "Spawn 3 (Right)",   pos: { x: 46, y: 71 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",    pos: { x: 44, y: 74 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Mid)",     pos: { x: 46, y: 66 }, lineups: ["mid_donut_smoke"] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back CT)", pos: { x: 30, y: 30 }, lineups: ["ct_elbow_smoke"] },
    { id: 2, name: "Spawn 2 (A Side)",  pos: { x: 25, y: 28 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Mid)",     pos: { x: 35, y: 32 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B Side)",  pos: { x: 38, y: 28 }, lineups: [] },
