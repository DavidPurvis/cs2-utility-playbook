...
export const LINEUPS = {
  ...
  red_room: {
    ...
    radarTarget: { worldX: -546.6, worldY: 13.6 },
  ...
  a_ct_smoke: {
    ...
    radarTarget: { worldX: -2031.4, worldY: 218.4 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  b_cave_smoke: {
    ...
    radarTarget: { worldX: -137, worldY: -191.2 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  a_main_pop_flash: {
    ...
    radarTarget: { worldX: -1826.6, worldY: 116 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_elbow_smoke: {
    ...
    radarTarget: { worldX: -802.6, worldY: -242.4 },
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Pillar)",  pos: { x: 42, y: 72 }, lineups: ["red_room"] },
    { id: 2, name: "Spawn 2 (Left)",    pos: { x: 39, y: 71 }, lineups: ["b_lurk_smoke"] },
    { id: 3, name: "Spawn 3 (Right)",   pos: { x: 45, y: 73 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",    pos: { x: 44, y: 74 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Mid)",     pos: { x: 42, y: 72 }, lineups: ["mid_donut_smoke"] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back CT)", pos: { x: 30, y: 30 }, lineups: ["ct_elbow_smoke"] },
    { id: 2, name: "Spawn 2 (A Side)",  pos: { x: 25, y: 28 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Mid)",     pos: { x: 34, y: 32 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B Side)",  pos: { x: 37, y: 28 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Close)",   pos: { x: 32, y: 35 }, lineups: [] },
  ],
};
