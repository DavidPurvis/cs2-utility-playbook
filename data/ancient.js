...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Pillar)",  pos: { x: 47, y: 84 }, lineups: ["red_room"] },
    { id: 2, name: "Spawn 2 (Left)",    pos: { x: 45, y: 83 }, lineups: ["b_lurk_smoke"] },
    { id: 3, name: "Spawn 3 (Right)",   pos: { x: 49, y: 85 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",    pos: { x: 48, y: 86 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Mid)",     pos: { x: 47, y: 84 }, lineups: ["mid_donut_smoke"] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back CT)", pos: { x: 54, y: 10 }, lineups: ["ct_elbow_smoke"] },
    { id: 2, name: "Spawn 2 (A Side)",  pos: { x: 51, y: 9 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Mid)",     pos: { x: 55, y: 11 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B Side)",  pos: { x: 57, y: 10 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Close)",   pos: { x: 53, y: 12 }, lineups: [] },
  ],
};
