...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Bathrooms)",   pos: { x: 60, y: 89 }, lineups: [] },
    { id: 2, name: "Spawn 2 (Monster)",     pos: { x: 67, y: 90 }, lineups: [] },
    { id: 3, name: "Spawn 3 (A Long)",      pos: { x: 61, y: 88 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Connector)",   pos: { x: 64, y: 91 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Back)",        pos: { x: 63, y: 92 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back)",        pos: { x: 49, y: 19 }, lineups: [] },
    { id: 2, name: "Spawn 2 (A site)",      pos: { x: 46, y: 20 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Connector)",   pos: { x: 51, y: 20 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B site)",      pos: { x: 52, y: 21 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Short)",       pos: { x: 50, y: 21 }, lineups: [] },
  ],
};
