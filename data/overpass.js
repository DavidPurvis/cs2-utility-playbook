...
export const LINEUPS = {
  ...
  bathrooms_b_heaven_smoke: {
    ...
    radarTarget: { worldX: -997.144, worldY: -348.92 },
  ...
  monster_smoke: {
    ...
    radarTarget: { worldX: -997.144, worldY: -987.896 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  a_long_smoke: {
    ...
    radarTarget: { worldX: -3233.56, worldY: 183.56 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_monster_smoke: {
    ...
    radarTarget: { worldX: -943.896, worldY: -1467.128 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_connector_smoke: {
    ...
    radarPos:    { worldX: -674.123, worldY: -2023.704 },
    radarTarget: { worldX: -2168.6, worldY: -615.16 },
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    ...
    { id: 2, name: "Spawn 2 (Monster)",     pos: { x: 68, y: 73 }, lineups: [] },
  ...
  CT: [
    ...
    { id: 2, name: "Spawn 2 (A site)",      pos: { x: 32, y: 23 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Connector)",   pos: { x: 55, y: 20 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B site)",      pos: { x: 72, y: 24 }, lineups: [] },
