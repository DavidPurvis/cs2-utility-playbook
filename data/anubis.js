...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Mid pillar)",  pos: { x: 48, y: 88 }, lineups: ["mid_connector_smoke"] },
    { id: 2, name: "Spawn 2 (Left)",        pos: { x: 45, y: 89 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Right)",       pos: { x: 51, y: 90 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 50, y: 89 }, lineups: [] },
    { id: 5, name: "Spawn 5 (A side)",      pos: { x: 45, y: 89 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back mid)",    pos: { x: 43, y: 21 }, lineups: ["ct_mid_smoke"] },
    { id: 2, name: "Spawn 2 (A side)",      pos: { x: 39, y: 20 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Center)",      pos: { x: 43, y: 19 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B side)",      pos: { x: 47, y: 21 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Connector)",   pos: { x: 46, y: 22 }, lineups: [] },
  ],
};
