...
export const LINEUPS = {
  ...
  mid_connector_smoke: {
    ...
    radarTarget: { worldX: 357.715, worldY: 922.624 },
  ...
  a_main_ct_smoke: {
    ...
    radarTarget: { worldX: -1299.322, worldY: 1884.774 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  a_main_pop_flash: {
    ...
    radarTarget: { worldX: -1192.416, worldY: 1991.68 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  b_site_molly: {
    ...
    radarTarget: { worldX: 945.696, worldY: 2152.038 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_mid_smoke: {
    ...
    radarTarget: { worldX: -123.36, worldY: 869.171 },
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Mid pillar)",  pos: { x: 50, y: 70 }, lineups: ["mid_connector_smoke"] },
    { id: 2, name: "Spawn 2 (Left)",        pos: { x: 44, y: 71 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Right)",       pos: { x: 55, y: 72 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",        pos: { x: 54, y: 71 }, lineups: [] },
    { id: 5, name: "Spawn 5 (A side)",      pos: { x: 44, y: 71 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Back mid)",    pos: { x: 50, y: 20 }, lineups: ["ct_mid_smoke"] },
    { id: 2, name: "Spawn 2 (A side)",      pos: { x: 35, y: 18 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Center)",      pos: { x: 50, y: 18 }, lineups: [] },
    { id: 4, name: "Spawn 4 (B side)",      pos: { x: 60, y: 20 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Connector)",   pos: { x: 57, y: 22 }, lineups: [] },
  ],
};
