...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Cart)",     pos: { x: 84, y: 36 }, lineups: ["window_smoke", "ct_smoke"] },
    { id: 2, name: "Spawn 2 (Dumpster)", pos: { x: 85, y: 36 }, lineups: ["jungle_smoke"] },
    { id: 3, name: "Spawn 3 (Left)",     pos: { x: 83, y: 38 }, lineups: ["stairs_smoke"] },
    { id: 4, name: "Spawn 4 (Back)",     pos: { x: 86, y: 38 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Right)",    pos: { x: 86, y: 35 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Center)",   pos: { x: 51, y: 7 }, lineups: [] },
    { id: 2, name: "Spawn 2 (A Side)",   pos: { x: 49, y: 7 }, lineups: [] },
    { id: 3, name: "Spawn 3 (B Side)",   pos: { x: 53, y: 8 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",     pos: { x: 51, y: 8 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Market)",   pos: { x: 54, y: 7 }, lineups: [] },
  ],
};
