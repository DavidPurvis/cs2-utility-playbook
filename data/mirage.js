...
export const LINEUPS = {
  ...
  window_smoke: {
    ...
    radarPos: { worldX: 1296, worldY: -352 },
    radarTarget: { x: 36.035, y: 42.871 },
  ...
  jungle_smoke: {
    ...
    radarPos: { worldX: 343.31, worldY: -621.61 },
    radarTarget: { x: 65, y: 49 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_smoke: {
    ...
    radarPos: { worldX: 1422.969, worldY: -248.03 },
    radarTarget: { x: 47.461, y: 49.707 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  stairs_smoke: {
    ...
    radarPos: { worldX: 1422.969, worldY: -248.031 },
    radarTarget: { x: 51.953, y: 67.871 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  a_site_molly: {
    ...
    radarPos: { worldX: -618.031, worldY: -1254.487 },
  ...
  short_smoke: {
    ...
    radarPos: { worldX: 1422.972, worldY: 36.469 },
    radarTarget: { x: 42, y: 44 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  b_apartments_smoke: {
    ...
    radarPos: { worldX: -1948.089, worldY: -312.155 },
  ...
  b_site_molly: {
    ...
    radarPos: { worldX: -1393.264, worldY: 807.969 },
  ...
  b_apps_flash: {
    ...
    radarPos: { worldX: -2635.969, worldY: 104.031 },
    radarTarget: { x: 20, y: 26 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_a_ramp_smoke: {
    ...
    radarPos: { worldX: -1547.981, worldY: -2407.969 },
  ...
  ct_palace_smoke: {
    ...
    radarPos: { worldX: -911.715, worldY: -139.846 },
    radarTarget: { x: 49.902, y: 37.109 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_b_apartments_smoke: {
    ...
    radarPos: { worldX: -2026.398, worldY: -2029.969 },
    radarTarget: { x: 64.063, y: 83.496 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_b_molly: {
    ...
    radarPos: { worldX: -496.031, worldY: -1512.823 },
    radarTarget: { x: 22, y: 44 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_window_molly: {
    ...
    radarPos: { worldX: 502.966, worldY: -675.886 },
  ...
  jungle_retake_flash: {
    ...
    radarPos: { worldX: -1188.033, worldY: -1216.343 },
    radarTarget: { x: 62, y: 55 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  b_retake_flash: {
    ...
    radarPos: { worldX: -161.031, worldY: 576.338 },
  ...
  palace_flash: {
    ...
    radarPos: { worldX: 367.969, worldY: -2144.76 },
    radarTarget: { x: 59, y: 57 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  underpass_to_b_smoke: {
    ...
    radarPos: { worldX: -968.061, worldY: -380.028 },
...
export const SETUP_POSITIONS = [
  ...
  },
  {
    ...
    side: "T",
    area: "A",
    pos: { worldX: 343.31, worldY: -621.61 },
  ...
  },
  {
    ...
    side: "T",
    area: "Mid",
    pos: { worldX: 1422.972, worldY: 36.469 },
    lineups: ["short_smoke"],
  ...
  },
  {
    ...
    side: "T",
    area: "A",
    pos: { worldX: 367.969, worldY: -2144.76 },
  ...
  },
  {
    ...
    side: "T",
    area: "B",
    pos: { worldX: -1948.089, worldY: -312.155 },
  ...
  },
  {
    ...
    side: "T",
    area: "B",
    pos: { worldX: -968.061, worldY: -380.028 },
  ...
  // ─── CT-SIDE ───────────────────────────────────────────────
  {
    ...
    side: "CT",
    area: "A",
    pos: { worldX: -1547.981, worldY: -2407.969 },
  ...
  },
  {
    ...
    side: "CT",
    area: "B",
    pos: { worldX: -2026.398, worldY: -2029.969 },
  ...
  },
  {
    ...
    side: "CT",
    area: "Mid",
    pos: { worldX: 502.966, worldY: -675.886 },
  ...
  },
  {
    ...
    side: "CT",
    area: "A",
    pos: { worldX: -1188.033, worldY: -1216.343 },
  ...
  },
  {
    ...
    side: "CT",
    area: "B",
    pos: { worldX: -161.031, worldY: 576.338 },
...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Cart)",     pos: { x: 34, y: 84 }, lineups: ["window_smoke", "ct_smoke"] },
    { id: 2, name: "Spawn 2 (Dumpster)", pos: { x: 36, y: 85 }, lineups: ["jungle_smoke"] },
    { id: 3, name: "Spawn 3 (Left)",     pos: { x: 32, y: 85 }, lineups: ["stairs_smoke"] },
    { id: 4, name: "Spawn 4 (Back)",     pos: { x: 70, y: 35 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Right)",    pos: { x: 37, y: 84 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Center)",   pos: { x: 70, y: 37 }, lineups: [] },
    { id: 2, name: "Spawn 2 (A Side)",   pos: { x: 66, y: 38 }, lineups: [] },
    { id: 3, name: "Spawn 3 (B Side)",   pos: { x: 68, y: 35 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",     pos: { x: 68, y: 16 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Market)",   pos: { x: 67, y: 39 }, lineups: [] },
  ],
};
