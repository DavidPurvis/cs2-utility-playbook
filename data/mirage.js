...
export const LINEUPS = {
  ...
  window_smoke: {
    ...
    radarTarget: { worldX: -670, worldY: -232.6 },
  ...
  a_ramp_flash: {
    ...
    radarTarget: { worldX: -158, worldY: 484.2 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  b_apartments_smoke: {
    ...
    radarTarget: { worldX: -2462, worldY: 125.8 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_a_ramp_smoke: {
    ...
    radarTarget: { worldX: -414, worldY: -335 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_b_apartments_smoke: {
    ...
    radarTarget: { worldX: -2103.6, worldY: -437.4 },
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    ...
    { id: 2, name: "Spawn 2 (Dumpster)", pos: { x: 51, y: 82 }, lineups: ["jungle_smoke"] },
    { id: 3, name: "Spawn 3 (Left)",     pos: { x: 47, y: 83 }, lineups: ["stairs_smoke"] },
    { id: 4, name: "Spawn 4 (Back)",     pos: { x: 49, y: 83 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Right)",    pos: { x: 53, y: 81 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Center)",   pos: { x: 68, y: 16 }, lineups: [] },
    { id: 2, name: "Spawn 2 (A Side)",   pos: { x: 65, y: 16 }, lineups: [] },
    { id: 3, name: "Spawn 3 (B Side)",   pos: { x: 71, y: 17 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",     pos: { x: 68, y: 16 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Market)",   pos: { x: 72, y: 16 }, lineups: [] },
  ],
};
