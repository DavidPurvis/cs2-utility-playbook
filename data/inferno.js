...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Left)",    pos: { x: 7, y: 70 }, lineups: [] },
    { id: 2, name: "Spawn 2 (Right)",   pos: { x: 10, y: 72 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Center)",  pos: { x: 9, y: 73 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",    pos: { x: 8, y: 75 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Ramp)",    pos: { x: 12, y: 70 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Center)",  pos: { x: 52, y: 14 }, lineups: [] },
    { id: 2, name: "Spawn 2 (Library)", pos: { x: 50, y: 13 }, lineups: [] },
    { id: 3, name: "Spawn 3 (B Side)",  pos: { x: 54, y: 15 }, lineups: [] },
    { id: 4, name: "Spawn 4 (A Side)",  pos: { x: 50, y: 12 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Back)",    pos: { x: 52, y: 16 }, lineups: [] },
  ],
};
