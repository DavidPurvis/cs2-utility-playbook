...
export const SPAWNS = {
  T: [
    ...
    { id: 2, name: "Spawn 2 (Right)",   pos: { x: 20, y: 80 }, lineups: [] },
  ...
  CT: [
    ...
    { id: 4, name: "Spawn 4 (A Side)",  pos: { x: 70, y: 14 }, lineups: [] },
