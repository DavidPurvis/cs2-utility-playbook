...
export const LINEUPS = {
  ...
  banana_ct_smoke: {
    ...
    radarTarget: { worldX: 321.448, worldY: 1762.608 },
  ...
  banana_coffins_smoke: {
    ...
    radarTarget: { worldX: 321.448, worldY: 1862.96 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  a_pit_smoke: {
    ...
    radarTarget: { worldX: 170.92, worldY: 2966.832 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  apps_flash: {
    ...
    radarTarget: { worldX: 522.152, worldY: 2615.6 },
    austincs: { video: "", timestamp: "", note: "" },
  },
  ...
  ct_banana_smoke: {
    ...
    radarTarget: { worldX: -832.6, worldY: 809.264 },
    austincs: { video: "", timestamp: "", note: "" },
  },
...
export const SPAWNS = {
  T: [
    { id: 1, name: "Spawn 1 (Left)",    pos: { x: 16, y: 78 }, lineups: [] },
    { id: 2, name: "Spawn 2 (Right)",   pos: { x: 21, y: 80 }, lineups: [] },
    { id: 3, name: "Spawn 3 (Center)",  pos: { x: 18, y: 82 }, lineups: [] },
    { id: 4, name: "Spawn 4 (Back)",    pos: { x: 18, y: 84 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Ramp)",    pos: { x: 22, y: 78 }, lineups: [] },
  ],
  CT: [
    { id: 1, name: "Spawn 1 (Center)",  pos: { x: 72, y: 18 }, lineups: [] },
    { id: 2, name: "Spawn 2 (Library)", pos: { x: 68, y: 16 }, lineups: [] },
    { id: 3, name: "Spawn 3 (B Side)",  pos: { x: 74, y: 20 }, lineups: [] },
    { id: 4, name: "Spawn 4 (A Side)",  pos: { x: 68, y: 14 }, lineups: [] },
    { id: 5, name: "Spawn 5 (Back)",    pos: { x: 72, y: 22 }, lineups: [] },
  ],
};
