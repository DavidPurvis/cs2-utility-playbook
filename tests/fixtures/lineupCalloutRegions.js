...
export const LINEUP_CALLOUT_REGIONS = {
  ancient: {
    ...
    B: { minX: 30, maxX: 75, minY: 30, maxY: 79 },
  },
  dust2: {
    Mid: { minX: 23, maxX: 69, minY: 13, maxY: 97 },
    A: { minX: 41, maxX: 92, minY: 11, maxY: 69 },
    B: { minX: 11, maxX: 35, minY: 15, maxY: 65 },
  },
  inferno: {
    Banana: { minX: 18, maxX: 55, minY: 21, maxY: 75 },
    B: { minX: 18, maxX: 74, minY: 18, maxY: 68 },
    A: { minX: 35, maxX: 84, minY: 9, maxY: 72 },
    Mid: { minX: 26, maxX: 54, minY: 42, maxY: 80 },
  },
  mirage: {
    A: { minX: 30, maxX: 78, minY: 11, maxY: 87 },
